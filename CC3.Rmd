...
```{r viz-vote, echo=FALSE, fig.height=4, fig.width=4, warning=FALSE}
...
```{r viz-gen1, echo=FALSE, fig.height=4, fig.width=4, warning=FALSE}
...
```{r viz-region, echo=FALSE, fig.align='right', fig.height=6, fig.width=10, warning=FALSE}
